package edu.example.kafkatest.web.config;

import edu.example.kafkatest.repository.UserRepository;
import edu.example.kafkatest.service.TokenService;
import edu.example.kafkatest.web.security.UserDetailsServiceImpl;
import edu.example.kafkatest.web.security.filter.JwtAuthenticationFilter;
import edu.example.kafkatest.web.security.jwt.JwtService;
import edu.example.kafkatest.web.security.provider.DbAuthenticationProvider;
import edu.example.kafkatest.web.security.provider.JwtAuthenticationProvider;
