package edu.example.light_messenger.web.config;

import edu.example.light_messenger.repository.UserRepository;
import edu.example.light_messenger.service.TokenService;
import edu.example.light_messenger.web.security.UserDetailsServiceImpl;
import edu.example.light_messenger.web.security.filter.JwtAuthenticationFilter;
import edu.example.light_messenger.web.security.jwt.JwtService;
import edu.example.light_messenger.web.security.provider.DbAuthenticationProvider;
import edu.example.light_messenger.web.security.provider.JwtAuthenticationProvider;
