package edu.example.light_messenger.web.security.jwt;
...
public class JwtService {
    ...
    public String generateFromUser(UserModel user) {
        return buildToken(new HashMap<>(), user, jwtExpiration);
    }

    private String buildToken(Map<String, Object> extraClaims, UserModel user, long expiration) {
